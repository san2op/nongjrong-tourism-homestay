...
if (isset($_POST['login']))
{
    ...
    $sql="SELECT * FROM managerregister  WHERE(email ='$email' and password ='$password')";
...
<h4>manager login</h4>
    ...
    <form method="post">
        ...
        <td><a href=managerregister.php><input type="button" value="click here to register"></a></td>
